    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/flux.png" alt="image" /></a> </div>
        </div>
  ...
  <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">
          <img src="assets/images/flux.png" alt="image" style="max-height: 50px; height: auto; width: auto; padding: 5px 0;">
        </a>
      </div>
